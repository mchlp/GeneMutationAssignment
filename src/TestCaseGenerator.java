...
public class TestCaseGenerator {
    ...
    public static final String STARTING_GENE = "TCATCAGATCAACGA";
    public static final String INVALID_GENE = "AAAAAAAAAAAAAAA";
    public static final int GENE_LENGTH = 15;
    public static final int NUM_VALID_GENES = 200_000;
    public static final int MAX_MUTATIONS = 6;
